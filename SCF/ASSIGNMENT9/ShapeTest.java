...
public class ShapeTest {
    ...
    {
        shape1 = screen.addShape(1, Shape.ShapeType.RECTANGLE, new Point(2.0, 2.0) , new ArrayList<Double>(Arrays.asList(3.0, 4.0)));
    ...
    {
        shape1 = screen.addShape(1, Shape.ShapeType.TRIANGLE, new Point(0, 0), new ArrayList<Double>(Arrays.asList(3.0, 4.0, 5.0, 5.0)));
        area = shape1.getArea();
        assertEquals(6, area);
    }
    ...
    {
        shape1 = screen.addShape(1, Shape.ShapeType.RECTANGLE, new Point(2, 1), new ArrayList<Double>(Arrays.asList(3.0, 4.0)));
        shape2 = screen.addShape(2, Shape.ShapeType.RECTANGLE, new Point(3, 2), new ArrayList<Double>(Arrays.asList(3.0, 4.0)));
        shape3 = screen.addShape(3, Shape.ShapeType.RECTANGLE, new Point(2, 2), new ArrayList<Double>(Arrays.asList(3.0, 4.0)));
    ...
    public void testShapesEnclosingPoint() 
    {
        ...
        shape1 = screen.addShape(1,Shape.ShapeType.RECTANGLE, new Point(50, 50), new ArrayList<Double>(Arrays.asList(6.0, 4.0)));
        System.out.println(shape1.getId());
        shape2 = screen.addShape(2,Shape.ShapeType.RECTANGLE, new Point(5, 5), new ArrayList<Double>(Arrays.asList(10.0, 14.0)));
        System.out.println(shape2.getId());
        shape3 = screen.addShape(3,Shape.ShapeType.RECTANGLE, new Point(2, 2), new ArrayList<Double>(Arrays.asList(3.0, 4.0)));
        System.out.println(shape3.getId());
        shape4 = screen.addShape(4,Shape.ShapeType.SQUARE, new Point(10, 10), new ArrayList<Double>(Arrays.asList(4.0)));
        List<Shape> actualResult = new ArrayList<Shape>();
