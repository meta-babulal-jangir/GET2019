...
public class Triangle implements Shape {
     ...
     */
	    public double getArea() 
	    {
		       ...
		       double tempArea = halfOfPerimeter * (halfOfPerimeter - side1) * (halfOfPerimeter - side2) * (halfOfPerimeter - side3);
     ...
     * to find  area covered by three points of Triangle
	    ...
	    * Parameter point1 of triangle
	    * Parameter point2 of triangle
	    * Parameter point3 of triangle
	    * Returns area covered by this three points
	    */
	    private double getAreaByVertices(Point point1, Point point2, Point point3) 
	    {
		       double area = Math.abs(point1.getxCoord() * (point2.getyCoord() - point3.getyCoord()) + point2.getxCoord() * (point3.getyCoord() - point1.getyCoord()) + point3.getxCoord() * (point1.getyCoord() - point2.getyCoord())) / 2;
		       return area;
	    }
