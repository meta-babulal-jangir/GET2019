 ...
 * Class to calculate mass of organic compounds
 */
public class MolecularMass {
	 ...
	 * @param compound in string form
	 * @return molecular mass in integer
	 */
	...
	/**
	 * calculates the base of sub compounds
	 * @param subCompound is in string form
	 * @return sub compound base in integer
	 */
	...
	/**
	 * @param base is in integer
	 * @return submass in integer form
	 */
