...
public class Cricket {
	    ...
	    * @param numberOfBowlers is number of bowlers 
	    * @param ballsForEachBowler[] is array of balls For Each Bowler
	    ...
	    public static int [] findOrderOfBolres(int numberOfBalls,int numberOfBowlers,int ballsForEachBowler[]) throws Exception 
     {
		       ...
		       if(sum!= numberOfBalls) 
         {
		       ...
		       Map<Integer, Integer> bowlerData = new HashMap<Integer, Integer>();
		       int key=0;
