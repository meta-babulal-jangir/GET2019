...
public class EvaluateExpression{
    ...
    public EvaluateExpression() 
    {
	   ...
	   * Parameter expression is string type, the expression you want to evaluate.
	   * Returns	string type, the evaluated value of expression.
	   */
	   public String evaluateExpression(String expression)
    {
	   ...
	   * Parameter expression a String variable, The Infix expression in a form of string.
	   * Returns the Postfix expression in a form of string. 
	   */
 	  public String infixToPostfix(String expression) 
    {
	   ...
	   * Parameter operand1	An integer variable, the first number which we have to evaluate.
	   * Parameter operand2	An integer variable, the second number which we have to evaluate.
	   * Parameter operator	A String variable, tell us the operation we have to perform on the two numbers.
	   * Returns	returns integer variable, The Answer after the evaluation of two number.
	   */
	   public int evaluate(int operand1, int operand2, String operator) 
    {
	  ...
	  /**
	   * Evaluate the Expression
	   * Parameter expression An string variable, The Expression you want to Evaluate.
	   * Returns	An Boolean Variable, The Evaluate Value of Expression. 
	   */
