package com.metacube.studentHib.model;
...
public class StudentForm {
	...
	@Pattern(regexp = "[1-8]+", message = "{validStudentClass}")
	...
	public StudentForm(String firstName, String lastName, String fatherName,
